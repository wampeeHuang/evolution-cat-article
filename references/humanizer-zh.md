...
> Step 4 执行指令。基于 Wikipedia "Signs of AI writing"（WikiProject AI Cleanup 维护）。
> 内化自原外部依赖 `humanizer-zh` skill，完整迁移 24 种模式检测 + 个性注入 + 质量评分。
...
**禁用词**：作为/充当、标志着、见证了、是……的体现/证明/提醒、极其重要的/至关重要的/核心的/关键性的作用/时刻、凸显/强调/彰显了其重要性/意义、反映了更广泛的、象征着其持续的/永恒的/持久的、为……做出贡献、为……奠定基础、标志着/塑造着、代表/标志着一个转变、关键转折点、不断演变的格局、焦点、不可磨灭的印记、深深植根于
...
**禁用词**：独立报道、地方/区域/国家媒体、由知名专家撰写、活跃的社交媒体账号
...
**禁用词**：突出/强调/彰显……、确保……、反映/象征……、为……做出贡献、培养/促进……、涵盖……、展示……
...
**禁用词**：拥有（夸张用法）、充满活力的、丰富的（比喻）、深刻的、增强其、展示、体现、致力于、自然之美、坐落于、位于……的中心、开创性的（比喻）、著名的、令人叹为观止的、必游之地、迷人的

**问题**：LLM 在保持中立语气方面存在严重问题，尤其是对"文化遗产"话题。倾向使用夸张的宣传性语言。
...
**禁用词**：行业报告显示、观察者指出、专家认为、一些批评者认为、多个来源/出版物（实际引用却很少）
...
**禁用词**：尽管其……面临若干挑战……、尽管存在这些挑战、挑战与遗产、未来展望
...
**高频 AI 词汇（全文扫描，命中 = 不通过）**：此外、与……保持一致、至关重要、深入探讨、强调、持久的、增强、培养、获得、突出（动词）、相互作用、复杂/复杂性、关键（形容词）、格局（抽象名词）、关键性的、展示、织锦（抽象名词）、证明、强调（动词）、宝贵的、充满活力的
...
**禁用词**：作为/代表/标志着/充当 [一个]、拥有/设有/提供 [一个]
...
**问题**：AI 将标题中的所有主要单词大写。中文标题通常不涉及大小写问题，此模式在中文中不太适用。
...
**问题**：ChatGPT 使用弯引号（""）而不是直引号（""）。中文中表现为英文引号的使用——应使用中文引号（「」或""）。
...
**禁用词**：希望这对您有帮助、当然！、一定！、您说得完全正确！、您想要……、请告诉我、这是一个……
...
**禁用词**：截至 [日期]、根据我最后的训练更新、虽然具体细节有限/稀缺……、基于可用信息……
...
| 维度 | 10 分标准 | 1 分标准 | 得分 |
|------|----------|---------|------|
| **直接性** | 直截了当，不绕圈宣告 | 充满铺垫和宣告 | /10 |
| **节奏** | 句子长短交错，有呼吸感 | 机械重复，每句等长 | /10 |
| **信任度** | 简洁明了，尊重读者智慧 | 过度解释，手把手引导 | /10 |
| **真实性** | 听起来像真人说话 | 机械生硬，像新闻稿 | /10 |
| **精炼度** | 无冗余，每句都在推进 | 大量废话和填充词 | /10 |
| **总分** | | | **/50** |
...
本指南基于 [Wikipedia:Signs of AI writing](https://en.wikipedia.org/wiki/Wikipedia:Signs_of_AI_writing)，由 WikiProject AI Cleanup 维护。那里记录的模式来自对维基百科上数千个 AI 生成文本实例的观察。
...
> 骨架层 — 通用中文写作口语词组，不绑定任何人设。个人词组库见 flesh/colloquial-phrases.md。
> 以下词组适用于所有中文写作者，来源于公开写作社区实践，非个人风格资产。

**转场和过渡**：怎么说呢、其实吧、你想想看、我跟你说、回到这块、顺着上面聊的

**表达判断**：我一直觉得、不是说 XX 不行而是说、我觉得还是挺重要的

**承认和自嘲**：说实话我也不确定、我自己也还在摸索、这个事儿我也踩过坑

**情绪表达**：我当时就愣住了、想想就觉得兴奋、太离谱了、一时间无语凝噎

**拉近距离**：很多朋友可能不知道、你如果关注这个领域的话、大家也都知道

**使用方法**：
1. 每 500 字至少出现 1-2 个口语词组（自然分布，不硬凑）
2. 词组是调味料不是主菜——全文口语词组超过 20 个 → 过于刻意
3. 同一词组不重复使用超过 2 次
